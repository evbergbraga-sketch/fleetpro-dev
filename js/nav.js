...
async function loadClientes(){const {data}=await sb.from('clientes').select('*').order('nome');allClientes=data||[];renderClientes();if(typeof renderDashboard==='function')renderDashboard();}
